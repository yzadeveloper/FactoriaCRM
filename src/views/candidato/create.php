    ...
    <div class="container-fluid bg-primary-subtle" >
        ...
        <form action="./store.php" method="POST" autocomplete="off">
            <div class="mb-3">
                ...
                <input type="text" name="dirección"  class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                ...
                <input type="date" name="date_create"  class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
